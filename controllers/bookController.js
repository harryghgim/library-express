...
exports.book_delete_post = function(req, res, next) {
  async.parallel({
    ...
    if (results.book_instance.length > 0) {
      ...
      res.render('book_delete', { title: 'Delete book', author: results.book, book_instances: results.book_instance } );
      return;
    }
    else {
      // Book has no book intances. Delete object and redirect to the list of books.
